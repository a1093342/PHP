...
<link href="css/sign_up.css" rel="stylesheet" media="screen and (min-width: 1000px)">
...
<div class="navigator">
    ...
    <!-- <div class="full-width" id="header">
        ...
        <!-- </div> -->
    <!-- </div> --> 
    <div class="block full-width clearfix">
    <div class="formdiv">
        ...
        <input type="text" name="tel" id="tel" pattern="09\d{2}\-?\d{3}\-?\d{3}" placeholder="請輸入格式09xx-xxx-xxx" required><br>
        <label for="password">設定密碼：</label>
        <input type="password" id="password" name="password" placeholder="請填入您的密碼" required><br>
        <label for="birthday">出生日期：</label>
        <input type="text" name="birthday" id="birthday" pattern='[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])' placeholder="請輸入格式YYYY-MM-DD" required><br>
